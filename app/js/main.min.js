...
/*! ==================== Main ================== */
$(window).on("load",(function(){function e(e){$(e).validate({rules:{name:"required",tel:"required",email:{required:!0,email:!0}},messages:{name:"Будь ласка, вкажіть своє ім'я",tel:"Вкажить свій номер телефона",email:{required:"Нам потрібна ваша електронна адреса, щоб зв'язатися з вами",email:"Ваша електронна адреса має бути у форматі name@domain.com"}}})}$(".polar-slider").slick({slidesToShow:1,slidesToScroll:1,arrows:!0,speed:500,prevArrow:'<button type="button" class="slick-prev"><img src="images/icons/shevron.svg"></button>',nextArrow:'<button type="button" class="slick-next"><img src="images/icons/shevron.svg"></button>',responsive:[{breakpoint:920,settings:{arrows:!1,dots:!0}}]}),$("ul.catalog__tabs").on("click","li:not(.catalog__tab_active)",(function(){$(this).addClass("catalog__tab_active").siblings().removeClass("catalog__tab_active").closest("div.catalog__page-wrap").find("div.catalog__content").removeClass("catalog__content_active").eq($(this).index()).addClass("catalog__content_active")})),$(".catalog-item__link").each((function(e){$(this).on("click",(function(t){t.preventDefault(),$(".catalog-item__content").eq(e).toggleClass("catalog-item__content_active"),$(".catalog-item__list").eq(e).toggleClass("catalog-item__list_active"),$(".catalog-item__list").eq(e).hasClass("catalog-item__list_active")?$(this).text("Назад"):$(this).text("Детальніше")}))})),$("[data-modal=consultation]").on("click",(function(){$(".overlay, #consultation").fadeIn("slow")})),$(".modal__close").on("click",(function(){$(".overlay, #consultation, #order, #thanks").fadeOut("slow")})),$(".catalog-item__btn").each((function(e){$(this).on("click",(function(){$("#order .modal__subtitle").text($(".catalog-item__title").eq(e).text()),$(".overlay, #order").fadeIn("slow")}))})),e("#consultation-form"),e("#consultation form"),e("#order form"),$("input[name=tel]").mask("+380(99) 999-99-99"),$("form").submit((function(e){if(e.preventDefault(),$(this).valid())return $.ajax({type:"POST",url:"mailer/smart.php",data:$(this).serialize()}).done((function(){$(this).find("input").val(""),$("#consultation, #order").fadeOut(),$(".overlay, #thinks").fadeIn("slow"),$("form").trigger("reset")})),!1})),$(window).scroll((function(){$(this).scrollTop()>1e3?$(".scrollup").fadeIn():$(".scrollup").fadeOut()})),$("a[href*='#']").on("click",(function(e){const t=$(this).attr("href");return $("html, body").stop().animate({scrollTop:$(t).offset().top},800),e.preventDefault(),!1}))}));